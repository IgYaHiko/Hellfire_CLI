...
import { getStoredToken, isTokenExpired, requireAuth, storeToken } from "../../../lib/token.js";
...
export async function loginAction(opts) {
  ...
  intro(chalk.bold("🔐 Drag into HELLFIRE_CLI Login"));
  ...
  try {
    ...
    console.log("");
    console.log(chalk.red("📱 Device Authorization Required"));
    console.log("");
    console.log(
